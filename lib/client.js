window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".xQIrBq_card{border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.xQIrBq_card:hover{border-color:var(--dsw-alias-label-dimmed,#8b949e)}.xQIrBq_cardOpen{background:var(--dsw-alias-bg-layer-2,#f6f8fa);border-color:var(--dsw-alias-label-dimmed,#8b949e)}.xQIrBq_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.xQIrBq_header:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f8cff);outline-offset:-2px}.xQIrBq_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.xQIrBq_name{color:var(--dsw-alias-label-primary,#1f2329);font-size:15px;font-weight:600;line-height:1.4}.xQIrBq_description{color:var(--dsw-alias-label-tertiary,#6b7280);font-size:13px;line-height:1.5}.xQIrBq_chevron{color:var(--dsw-alias-label-tertiary,#6b7280);flex:none;margin-left:8px;font-size:12px;transition:transform .16s}.xQIrBq_chevronOpen{transform:rotate(180deg)}.xQIrBq_body{border-top:1px solid var(--dsw-alias-border-l2,#d0d7de);flex-direction:column;gap:14px;margin:0 16px;padding:14px 0 8px;display:flex}.xQIrBq_status{color:var(--dsw-alias-label-tertiary,#6b7280);margin:4px 0;font-size:13px;line-height:1.5}.xQIrBq_field{flex-direction:column;gap:4px;display:flex}.xQIrBq_fieldRow{gap:10px;display:flex}.xQIrBq_fieldRow>.xQIrBq_field{flex:1 1 0;min-width:0}.xQIrBq_fieldLabel{color:var(--dsw-alias-label-primary,#1f2329);font-size:13px;font-weight:500}.xQIrBq_fieldHint{color:var(--dsw-alias-label-tertiary,#6b7280);font-size:12px;line-height:1.45}.xQIrBq_input{box-sizing:border-box;border:1px solid var(--dsw-alias-line-default,#d0d7de);background:var(--dsw-alias-bg-base,#fff);width:100%;color:var(--dsw-alias-label-primary,#1f2329);border-radius:6px;padding:6px 8px;font-size:13px}.xQIrBq_input:focus{outline:2px solid var(--dsw-alias-accent-default,#4f8cff);outline-offset:-1px}.xQIrBq_textarea{resize:vertical;min-height:56px;font-family:inherit;}.xQIrBq_rowList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.xQIrBq_row{align-items:center;gap:6px;display:flex}.xQIrBq_rowLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary,#1f2329);flex:1 1 0;font-size:13px;overflow:hidden}.xQIrBq_select{box-sizing:border-box;border:1px solid var(--dsw-alias-line-default,#d0d7de);background:var(--dsw-alias-bg-base,#fff);width:100%;color:var(--dsw-alias-label-primary,#1f2329);border-radius:6px;padding:6px 8px;font-size:13px}.xQIrBq_select:focus{outline:2px solid var(--dsw-alias-accent-default,#4f8cff);outline-offset:-1px}.xQIrBq_rowInput{flex:1 1 0;}.xQIrBq_rowInputNarrow{flex:0 110px;}.xQIrBq_rowRemove{border:1px solid var(--dsw-alias-line-default,#d0d7de);background:var(--dsw-alias-bg-subtle,#f6f8fa);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;border-radius:6px;flex:none;padding:4px 8px;font-size:12px}.xQIrBq_rowRemove:hover{border-color:var(--dsw-alias-danger-default,#d1242f);color:var(--dsw-alias-danger-default,#d1242f)}.xQIrBq_rowAdd{border:1px dashed var(--dsw-alias-line-strong,#a6adb4);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;background:0 0;border-radius:6px;align-self:flex-start;padding:4px 10px;font-size:12px}.xQIrBq_rowAdd:hover{border-color:var(--dsw-alias-accent-default,#4f8cff);color:var(--dsw-alias-accent-default,#4f8cff)}.xQIrBq_footer{align-items:center;gap:10px;margin-top:2px;display:flex}.xQIrBq_primaryButton{background:var(--dsw-alias-accent-default,#4f8cff);color:#fff;cursor:pointer;border:none;border-radius:6px;padding:6px 14px;font-size:13px;font-weight:500}.xQIrBq_primaryButton:hover{background:var(--dsw-alias-accent-strong,#3b76e0)}.xQIrBq_primaryButton:disabled{opacity:.6;cursor:default}.xQIrBq_ghostButton{border:1px solid var(--dsw-alias-line-default,#d0d7de);background:var(--dsw-alias-bg-subtle,#f6f8fa);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;border-radius:6px;padding:6px 12px;font-size:13px}.xQIrBq_ghostButton:hover{border-color:var(--dsw-alias-line-strong,#a6adb4)}.xQIrBq_saveStatus{font-size:12px;line-height:1.4}.xQIrBq_saveStatusOk{color:var(--dsw-alias-success-default,#1a7f37)}.xQIrBq_saveStatusError{color:var(--dsw-alias-danger-default,#d1242f)}.xQIrBq_saveStatusHint{color:var(--dsw-alias-label-tertiary,#6b7280)}";
		const tagId = "dsh-llm-proxy/proxy-model.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-llm-proxy";
		...
		*/
		...
		function CardBody(props) {
			...
			const rowLabel = (row) => row.providerLabel !== "" ? `[${row.providerLabel}] ${row.name}` : row.name;
			const selectedNames = () => {
				const byKey = new Map(models.map((row) => [row.key, rowLabel(row)]));
				return form.proxiedModels.map((key) => byKey.get(key) ?? key);
			};
			/**
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							form.proxiedModels.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
								className: proxy_model_module_css_default.fieldHint,
								children: [
									t("selectedModels"),
									"：",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						className: proxy_model_module_css_default.chevron,
						children: open ? "▾" : "▸"
					})]
		...
		*/
		...
		const zh = {
			nav: "模型代理",
			title: "模型代理",
			description: "配置 DSH LLM 请求的代理端点、走代理的模型与失败重试（dsh-llm-proxy）。保存后立即生效，无需重启。",
			statusLoading: "加载中…",
		...
		const en = {
			nav: "Proxy Model",
			title: "Proxy Model",
			description: "Configure the proxy endpoint, proxied models and retry policy for DSH LLM requests (dsh-llm-proxy). Changes apply immediately, no restart needed.",
