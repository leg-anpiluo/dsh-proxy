...
function failureOf(error) {
  // Structural (not instanceof) on purpose: the seam throws the HOST copy's
  // SettingsConflictError, whose class identity differs from any copy this
  // plugin could resolve — cross-copy instanceof is always false. Both
  // 0.1.0-rc.8 and 0.1.2-rc.1 set `this.name = "SettingsConflictError"`.
  if (error?.name === 'SettingsConflictError') {
