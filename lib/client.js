window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\C2629\Desktop\temp2\dsh-proxy\src\client\proxy-model.module.css.mjs
		const css = ".UVZj1G_card{border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.UVZj1G_card:hover{border-color:var(--dsw-alias-label-dimmed,#8b949e)}.UVZj1G_cardOpen{background:var(--dsw-alias-bg-layer-2,#f6f8fa);border-color:var(--dsw-alias-label-dimmed,#8b949e)}.UVZj1G_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.UVZj1G_header:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f8cff);outline-offset:-2px}.UVZj1G_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.UVZj1G_name{color:var(--dsw-alias-label-primary,#1f2329);font-size:15px;font-weight:600;line-height:1.4}.UVZj1G_description{color:var(--dsw-alias-label-tertiary,#6b7280);font-size:13px;line-height:1.5}.UVZj1G_chevron{color:var(--dsw-alias-label-tertiary,#6b7280);flex:none;transition:transform .16s}.UVZj1G_chevronOpen{transform:rotate(180deg)}.UVZj1G_body{border-top:1px solid var(--dsw-alias-border-l2,#d0d7de);flex-direction:column;gap:14px;margin:0 16px;padding:14px 0 8px;display:flex}.UVZj1G_status{color:var(--dsw-alias-label-tertiary,#6b7280);margin:4px 0;font-size:13px;line-height:1.5}.UVZj1G_field{flex-direction:column;gap:4px;display:flex}.UVZj1G_fieldRow{gap:10px;display:flex}.UVZj1G_fieldRow>.UVZj1G_field{flex:1 1 0;min-width:0}.UVZj1G_fieldRowDisabled{opacity:.5}.UVZj1G_checkRow{cursor:pointer;user-select:none;align-items:center;gap:8px;display:inline-flex}.UVZj1G_checkbox{width:15px;height:15px;accent-color:var(--dsw-alias-state-business-primary,#4f8cff);cursor:pointer}.UVZj1G_checkLabel,.UVZj1G_fieldLabel{color:var(--dsw-alias-label-primary,#1f2329);font-size:13px;font-weight:500}.UVZj1G_fieldHint{color:var(--dsw-alias-label-tertiary,#6b7280);font-size:12px;line-height:1.45}.UVZj1G_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-2,#f6f8fa);width:100%;color:var(--dsw-alias-label-primary,#1f2329);color-scheme:light;border-radius:6px;padding:6px 8px;font-size:13px}.UVZj1G_input:focus{outline:2px solid var(--dsw-alias-state-business-primary,#4f8cff);outline-offset:-1px}.UVZj1G_textarea{resize:vertical;min-height:56px;font-family:inherit;}.UVZj1G_rowList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.UVZj1G_row{align-items:center;gap:6px;display:flex}.UVZj1G_rowLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary,#1f2329);flex:1 1 0;font-size:13px;overflow:hidden}.UVZj1G_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-2,#f6f8fa);width:100%;color:var(--dsw-alias-label-primary,#1f2329);color-scheme:light;border-radius:6px;padding:6px 8px;font-size:13px}.UVZj1G_select:focus{outline:2px solid var(--dsw-alias-state-business-primary,#4f8cff);outline-offset:-1px}body[data-ds-dark-theme] .UVZj1G_input,body[data-ds-dark-theme] .UVZj1G_select{color-scheme:dark}.UVZj1G_select option{background:var(--dsw-alias-bg-layer-2,#f6f8fa);color:var(--dsw-alias-label-primary,#1f2329)}.UVZj1G_rowInput{flex:1 1 0;}.UVZj1G_rowInputNarrow{flex:0 110px;}.UVZj1G_rowRemove{border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-2,#f6f8fa);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;border-radius:6px;flex:none;padding:4px 8px;font-size:12px}.UVZj1G_rowRemove:hover{border-color:var(--dsw-alias-state-error-primary,#d1242f);color:var(--dsw-alias-state-error-primary,#d1242f)}.UVZj1G_rowAdd{border:1px dashed var(--dsw-alias-border-l3,#a6adb4);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;background:0 0;border-radius:6px;align-self:flex-start;padding:4px 10px;font-size:12px}.UVZj1G_rowAdd:hover{border-color:var(--dsw-alias-state-business-primary,#4f8cff);color:var(--dsw-alias-state-business-primary,#4f8cff)}.UVZj1G_footer{align-items:center;gap:10px;margin-top:2px;display:flex}.UVZj1G_primaryButton{background:var(--dsw-alias-button-primary-fill,#4f8cff);color:var(--dsw-alias-label-primary-foreground,#fff);cursor:pointer;border:none;border-radius:6px;padding:6px 14px;font-size:13px;font-weight:500}.UVZj1G_primaryButton:hover{background:var(--dsw-alias-button-primary-hover,#3b76e0)}.UVZj1G_primaryButton:disabled{opacity:.6;cursor:default}.UVZj1G_ghostButton{border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-2,#f6f8fa);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;border-radius:6px;padding:6px 12px;font-size:13px}.UVZj1G_ghostButton:hover{border-color:var(--dsw-alias-border-l3,#a6adb4)}.UVZj1G_saveStatus{font-size:12px;line-height:1.4}.UVZj1G_saveStatusOk{color:var(--dsw-alias-state-success-primary,#1a7f37)}.UVZj1G_saveStatusError{color:var(--dsw-alias-state-error-primary,#d1242f)}.UVZj1G_saveStatusHint{color:var(--dsw-alias-label-tertiary,#6b7280)}.UVZj1G_testBarHint{color:var(--dsw-alias-label-tertiary,#6b7280);font-size:11px;line-height:1.4}.UVZj1G_rowWrap{flex-direction:column;gap:2px;display:flex}.UVZj1G_rowTest{border:1px solid var(--dsw-alias-border-l2,#d0d7de);background:var(--dsw-alias-bg-layer-2,#f6f8fa);color:var(--dsw-alias-label-secondary,#4b5563);cursor:pointer;border-radius:6px;flex:none;padding:4px 8px;font-size:12px}.UVZj1G_rowTest:hover{border-color:var(--dsw-alias-state-business-primary,#4f8cff);color:var(--dsw-alias-state-business-primary,#4f8cff)}.UVZj1G_rowTest:disabled{opacity:.55;cursor:default}.UVZj1G_testResult{padding-left:2px;font-size:12px;line-height:1.4}.UVZj1G_testResultOk{color:var(--dsw-alias-state-success-primary,#1a7f37)}.UVZj1G_testResultError{color:var(--dsw-alias-state-error-primary,#d1242f)}";
		...
		var proxy_model_module_css_default = {
			"textarea": "UVZj1G_textarea",
			"chevronOpen": "UVZj1G_chevronOpen",
			"checkLabel": "UVZj1G_checkLabel",
			"rowInput": "UVZj1G_rowInput",
			"fieldLabel": "UVZj1G_fieldLabel",
			"rowAdd": "UVZj1G_rowAdd",
			"rowList": "UVZj1G_rowList",
			"rowLabel": "UVZj1G_rowLabel",
			"chevron": "UVZj1G_chevron",
			"saveStatusError": "UVZj1G_saveStatusError",
			"checkbox": "UVZj1G_checkbox",
			"primaryButton": "UVZj1G_primaryButton",
			"headText": "UVZj1G_headText",
			"checkRow": "UVZj1G_checkRow",
			"testResult": "UVZj1G_testResult",
			"select": "UVZj1G_select",
			"fieldRowDisabled": "UVZj1G_fieldRowDisabled",
			"footer": "UVZj1G_footer",
			"name": "UVZj1G_name",
			"ghostButton": "UVZj1G_ghostButton",
			"rowTest": "UVZj1G_rowTest",
			"testResultOk": "UVZj1G_testResultOk",
			"saveStatusOk": "UVZj1G_saveStatusOk",
			"header": "UVZj1G_header",
			"row": "UVZj1G_row",
			"fieldHint": "UVZj1G_fieldHint",
			"saveStatusHint": "UVZj1G_saveStatusHint",
			"testResultError": "UVZj1G_testResultError",
			"saveStatus": "UVZj1G_saveStatus",
			"description": "UVZj1G_description",
			"rowWrap": "UVZj1G_rowWrap",
			"cardOpen": "UVZj1G_cardOpen",
			"rowInputNarrow": "UVZj1G_rowInputNarrow",
			"status": "UVZj1G_status",
			"field": "UVZj1G_field",
			"testBarHint": "UVZj1G_testBarHint",
			"card": "UVZj1G_card",
			"input": "UVZj1G_input",
			"fieldRow": "UVZj1G_fieldRow",
			"body": "UVZj1G_body",
			"rowRemove": "UVZj1G_rowRemove"
		};
		//#endregion
